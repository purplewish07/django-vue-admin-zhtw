<template>
	<view class="u-demo">
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				<view class="u-item-title">鏤空狀態</view>
			...
			<view class="u-config-item">
				<view class="u-item-title">星星數量</view>
...
<script>
	export default {
		data() {
			return {
				// 1.4.5後推薦使用v-model雙向綁定，棄用current
				// current: 1,
				activeColor: '#FA3534',
