	...
	<view class="u-demo">
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :list="['圓形', '圓角方形']" @change="modeChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">性別選擇</view>
				<u-subsection vibrateShort :list="['男', '女', '不顯示']" @change="sexChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">等級</view>
				<u-subsection vibrateShort :list="['顯示', '不顯示']" @change="levelChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">自定義內容</view>
				<u-subsection vibrateShort current="0" :list="['圖片', '文字']" @change="styleChange"></u-subsection>
			</view>
			<view class="u-config-item">
