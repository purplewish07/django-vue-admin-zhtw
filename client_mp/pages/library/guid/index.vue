	...
	<view class="u-demo">
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				<view class="u-item-title">長度</view>
				<u-subsection vibrateShort current="2" :list="['10', '16', '32', 'rfc4122標準']" @change="lengthChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">首字符為"u"</view>
				<u-subsection vibrateShort :list="['是', '否']" @change="fristUChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">取值基數(進制)</view>
