	...
	<view class="u-demo">
		<view class="u-demo-wrap">
			...
			<view class="u-demo-area">
				<view class="" :style="{
					...
					<view class="rect-block-1">第一個節點</view>
					<view class="rect-block-2">第2個節點</view>
					<view class="u-no-demo-here">節點信息為</view>
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :list="['第一個節點', '第2個節點']" @change="elChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">指定元素置頂</view>
