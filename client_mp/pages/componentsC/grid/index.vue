			...
			<view class="u-demo-area">
				...
				<u-grid :col="col" @click="click" v-if="!isSwiper" :border="border">
					<u-grid-item name="item1" :index="0" @click="itemClick">
						...
						<view class="grid-text">圖片</view>
					</u-grid-item>
					<u-grid-item :index="1">
						<u-icon name="lock" :size="46"></u-icon>
						<view class="grid-text">鎖頭</view>
					</u-grid-item>
					<u-grid-item :index="2">
					...
					<u-grid-item :index="7">
						...
						<view class="grid-text">快進</view>
					</u-grid-item>
					<u-grid-item :index="8">
						<u-icon name="shopping-cart" :size="46"></u-icon>
						<view class="grid-text">購物車</view>
					</u-grid-item>
				</u-grid>
