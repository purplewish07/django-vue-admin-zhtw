<template>
  <div class="app-container">
    ...
    <el-dialog
      ...
      :title="dialogType === 'edit' ? '編輯部門' : '新增部門'"
    >
      <el-form
        ref="Form"
        :model="org"
      ...
      >
        ...
        <el-form-item label="上級部門" prop="parent">
          <treeselect
            v-model="org.parent"
            :multiple="false"
            :options="tableData"
      ...
      <span slot="footer">
        ...
        <el-button type="primary" @click="confirmOrg('Form')">確認</el-button>
      </span>
    </el-dialog>
  </div>
</template>
