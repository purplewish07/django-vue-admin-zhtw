	...
	<view class="u-demo">
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :current="current" :list="['線型', '圓型']" @change="modeChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">增減</view>
				<u-subsection vibrateShort :list="['減少30%', '增加30%']" @change="calcChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">自定義樣式(線型時有效)</view>
				<u-subsection vibrateShort current="1" :list="['是', '否']" @change="styleChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">動態條紋(線型時有效)</view>
