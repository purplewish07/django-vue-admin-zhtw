	...
	<view class="u-demo">
		<view class="u-demo-wrap">
			...
			<view class="u-demo-area">
				<view class="u-no-demo-here">滾動頁面即可在右下角看到返回頂部的按鈕</view>
			</view>
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :list="['圓形', '方形']" @change="modeChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">組件位置</view>
				<u-subsection vibrateShort :list="['默認', '自定義']" @change="positionChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">顯示組件的滾動條距離</view>
