	...
	<view class="u-demo">
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :list="['方框', '下劃線', '中劃線']" @change="modeChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">輸入長度</view>
				<u-subsection vibrateShort :list="[4, 5, 6]" @change="maxLengthChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<!-- #ifdef MP-WEIXIN -->
				<view class="u-item-title">初始值(為滿足演示需要，微信小程序切換會有抖動，非性能問題)</view>
				<!-- #endif -->
				<!-- #ifndef MP-WEIXIN -->
			...
			<view class="u-config-item">
				<view class="u-item-title">呼吸燈效果</view>
			...
			<view class="u-config-item">
				<view class="u-item-title">點替代輸入值</view>
