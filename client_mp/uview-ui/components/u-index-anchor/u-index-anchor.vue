<template>
	<!-- 支付寶小程序使用$u.getRect()獲取組件的根元素尺寸，所以在外面套一個"殼" -->
	<view>
...
<script>
	 ...
	 * @property {Boolean} use-slot 是否使用自定義內容的插槽（默認false）
	 * @property {String Number} index 索引字符，如果定義了use-slot，此參數自動失效
	 * @property {Object} custStyle 自定義樣式，對像形式，如"{color: 'red'}"
	 * @event {Function} default 錨點位置顯示內容，默認為索引字符
