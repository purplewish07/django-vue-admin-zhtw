<template>
  <div class="app-container">
    <el-row :gutter="12">
        ...
        <el-card>
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item>
              <template slot="label"> 邏輯核心數 </template>
              {{ cpuData.count }}
            </el-descriptions-item>
            <el-descriptions-item>
              <template slot="label"> 物理核心數 </template>
              {{ cpuData.lcount }}
            </el-descriptions-item>
            <el-descriptions-item>
              <template slot="label"> 當前使用率 </template>
              {{ cpuData.percent }}%
            </el-descriptions-item>
          </el-descriptions>
        </el-card>
      ...
      <el-col :span="8">
        <el-card>
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item>
              <template slot="label"> 總內存 </template>
              {{ memoryData.total }}GB
            </el-descriptions-item>
            <el-descriptions-item>
              <template slot="label"> 已用內存 </template>
              {{ memoryData.used }}GB
            </el-descriptions-item>
            <el-descriptions-item>
              <template slot="label"> 當前使用率 </template>
      ...
      <el-col :span="8">
        <el-card>
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item>
              <template slot="label"> 總大小 </template>
              {{ diskData.total }}GB
            </el-descriptions-item>
            <el-descriptions-item>
              <template slot="label"> 已用內存 </template>
    ...
    <el-card style="margin-top: 2px">
      ...
      >
        <el-table-column prop="name" label="日誌名稱"> </el-table-column>
        <el-table-column prop="size" label="日誌大小"> </el-table-column>
      ...
      <el-dialog :visible.sync="dialogVisible" width="80%" title="日誌詳情">
