	...
	<view class="u-demo">
		<view class="u-demo-wrap">
			...
			<view class="u-demo-area">
				<u-subsection v-if="change" :bold="bold" :active-color="activeColor" :current="current" :mode="mode" :list="['代付款', '待收貨', '待評價']"></u-subsection>
			</view>
		</view>
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				<view class="u-item-title">模式選擇(為滿足演示需要，切換會有抖動，非性能問題)</view>
			...
			<view class="u-config-item">
				<view class="u-item-title">活動選項字顏色</view>
