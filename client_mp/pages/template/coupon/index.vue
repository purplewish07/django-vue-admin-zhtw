	...
	<view class="u-wrap">
		<view class="meituan">
			<view class="content">
				...
				<view class="centre">
					<view class="title">【洗牙】8元無門檻紅包</view>
			...
			<view class="tips">
				...
				<view class="explain u-line-1">滿8.1元可用、限最新版本客戶端使用</view>
		...
		<view class="jingdong">
			<view class="left">
				...
				<view class="type">滿149元可用</view>
			</view>
			<view class="right">
				<view class="top">
					<view class="title">
						<text class="tag">限品類東券</text>
						<text>僅可購買個人護理部分商品</text>
					</view>
					<view class="bottom">
		...
		<view class="taobao">
			<view class="title">
				<view class="left">
					...
					<view class="store">襪子精保護協會</view>
				</view>
				<view class="entrance">進店</view>
			</view>
			<view class="ticket">
				<view class="left">
					<image
