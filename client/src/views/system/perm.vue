  ...
  <div class="app-container">
    ...
    >
      ...
      >
        <el-form-item label="類型">
          <el-radio-group v-model="perm.type">
            <el-radio label="目錄"></el-radio>
            <el-radio label="菜單"></el-radio>
      ...
      <span slot="footer">
        ...
        <el-button type="primary" @click="confirmPerm('Form')">確認</el-button>
      </span>
    </el-dialog>
  </div>
</template>
