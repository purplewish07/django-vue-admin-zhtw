	...
	<view class="u-demo">
		<view class="u-demo-wrap">
			...
			<view class="u-demo-area">
				<u-button @click="openPage">點擊跳轉</u-button>
			</view>
		</view>
