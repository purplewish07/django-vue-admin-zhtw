	...
	<view class="u-demo">
		<view class="u-demo-wrap">
			...
			<view class="u-demo-area">
				...
				<u-button @click="btnClick">喚起彈窗</u-button>
				...
				>
					<view v-if="mode == 'center'" style="height: 400rpx">
						<view class="close-btn">
							<u-button @click="show = false;" size="medium">關閉彈窗</u-button>
						</view>
					</view>
					<view class="close-btn" v-if="mode != 'center'">
						<u-button size="medium" @click="show = false;">關閉彈窗</u-button>
					</view>
				</u-popup>
			</view>
		</view>
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :current="show == false ? 1 : 0" :list="['打開', '關閉']" @change="showChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">彈出方向</view>
				<u-subsection vibrateShort :current="2" :list="['上', '下', '左', '右', '中']" @change="modeChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">關閉按鈕</view>
				<u-subsection vibrateShort :list="['顯示', '隱藏']" @change="closeChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">關閉按鈕位置</view>
