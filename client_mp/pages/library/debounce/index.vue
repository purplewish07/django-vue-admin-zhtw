	...
	<view class="u-demo">
		<view class="u-demo-wrap">
			...
			<view class="u-demo-area">
				<view class="no-mode-here">
					選擇節流或者防抖模式，點擊按鈕，將會執行回調並顯示在下方：
				</view>
				<view class="u-demo-result-line" v-if="result.length">
					<view v-for="(item, index) in result" :key="index">{{(index >= 1) ? '-' : ''}}回調</view>
				</view>
			</view>
		</view>
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :list="['節流', '防抖']" @change="modeChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">時間間隔</view>
				<u-subsection vibrateShort current="1" :list="['500ms', '1000ms', '2000ms']" @change="timeoutChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">執行時機</view>
				<u-subsection vibrateShort :list="['開始處', '結束處']" @change="immediateChange"></u-subsection>
			</view>
		</view>
	</view>
</template>
