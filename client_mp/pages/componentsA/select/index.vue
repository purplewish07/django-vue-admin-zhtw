	...
	<view class="u-demo">
		...
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				...
				<u-subsection vibrateShort :current="current" :list="['打開', '收起']" @change="statusChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">模式</view>
				<u-subsection vibrateShort :list="['單列', '多列獨立', '多列聯動']" @change="modeChange"></u-subsection>
			</view>
		</view>
	</view>
</template>
