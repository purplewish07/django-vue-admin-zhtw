	...
	<view class="u-demo">
		<view class="u-demo-wrap">
			...
			<view class="u-demo-area">
				...
				<u-button :custom-style="{marginTop: '20rpx'}" @click="upload">上傳</u-button>
				<u-button :custom-style="{marginTop: '40rpx'}" @click="clear">清空列表</u-button>
				<!-- <u-button :custom-style="{marginTop: '40rpx'}" @click="reUpload">重新上傳</u-button> -->
			</view>
		</view>
		<view class="u-config-wrap">
			...
			<view class="u-config-item">
				<view class="u-item-title">上傳方式</view>
				<u-subsection vibrateShort current="1" :list="['自動上傳', '手動上傳']" @change="autoUploadChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">自定義控件(進度條和刪除按鈕)</view>
				<u-subsection vibrateShort :list="['顯示', '隱藏']" @change="controlChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">最大上傳數量</view>
				<u-subsection vibrateShort current="1" :list="['1', '2', '4']" @change="maxCountChange"></u-subsection>
			</view>
			<view class="u-config-item">
				<view class="u-item-title">自定義樣式(預覽區域和上傳按鈕)</view>
